...
<div class="container">
            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    function worked_fields() {
                    	...
                    	divtest.setAttribute("class", "form-group removeclass"+room);
                    	var rdiv = 'removeclass'+room;
                        divtest.innerHTML = '<div class="col-sm-7 nopadding"><div class="form-group"><input type="text" class="form-control" id="work" name="worked[]" value="" placeholder="worked at "></div></div><div class="col-sm-5 nopadding"><div class="form-group"><div class="input-group"><input type="text" class="form-control" id="worked" name="exdesignation[]" value="" placeholder="designation"><div class="input-group-btn"><button class="btn btn-danger" type="button" onclick="remove_worked_fields('+ room +');"><span class="glyphicon glyphicon-minus" aria-hidden="true"></span></button></div></div></div><div class="worked_clear"></div></div>';
                        objTo.appendChild(divtest);
                    }
 ...
 <form method="POST" action="{{url('/ex_register')}}" enctype="multipart/form-data">
    ...
    <input type='radio' class="col-sm-2 nopadding" type="text" id="id" name="id" value= "{{auth::user()->id}}"  checked="checked" />
    </div>
    <br>
	<div class="form-group">
			<div class="panel row">
  					...
  					<div class="form-group">
    					<div class="input-group">
      						...
      						<div class="input-group-btn">
        						<button class="btn btn-success" type="button"  onclick="educations_fields();"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> </button>
      						</div>
    					</div>
  					</div>
				</div>
            	...
            	<label class="col-md-2 control-label" name="working">Work History :</label>
           				<div class="col-md-8">
        					...
        					<div class="col-sm-5 nopadding">
								<div class="form-group">
									<div class="input-group">
    									<input type="text" class="form-control" id="worked" name="exdesignation[]" value="" placeholder="designation">
  										<div class="input-group-btn">
