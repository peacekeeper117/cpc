...
{{method_field('PUT')}}
	<div class="form-group">
			<div class="panel row">
            <label class="col-md-4 control-label" name="resume">Name :</label>
            
                <input  type="text" id="name" name="name" value="{{ $prof->name }}"/>
        	</div>
		<div class="panel row">
            <label class="col-md-4 control-label" name="resume">devskill :</label>
           ...
           <input  type="text" id="uva_id" name="uva_id" value="{{ $prof->uva_id }}"/>
       		...
       		<div class="panel row">
            <label class="col-md-4 control-label" name="resume">codeforces:</label>
